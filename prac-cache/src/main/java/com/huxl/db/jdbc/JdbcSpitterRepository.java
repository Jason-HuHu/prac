package com.huxl.db.jdbc;

import com.huxl.db.SpitterRepository;
import com.huxl.domain.Spitter;
...
public class JdbcSpitterRepository implements SpitterRepository {
	...
	public long count() {
		long count = jdbcTemplate.queryForList("select * from Spitter").size();
		System.out.println("Spitter的数量为：" + count);
		return count;
	}
